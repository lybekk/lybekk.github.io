    ...
    <nav className="navbar is-fixed-bottom " role="navigation" aria-label="main navigation">
      <div className="navbar-brand">
        <Link to="/" className="navbar-item">
          <h2 className="title is-2 has-text-link has-text-weight-light">{siteTitle}</h2>
        </Link>
      </div>
          ...
          <div className="navbar-item has-dropdown has-dropdown-up is-hoverable">
            ...
            <div className="navbar-dropdown is-boxed">
              ...
              {feedbackItems.map((item, i) => (
                <a className="navbar-item has-text-link" href={item.href} target="_blank" rel="noreferrer" key={i}>
